  ...
  return (function () {
    ...
    var t = {
        ...
        853: function (t, e, i) {
          ...
          function et(t) {
            ...
            if (h) {
              var A = X(i),
                j = "clientHeight",
                P = "clientWidth";
              if ((A === T(i) && "static" !== R((A = N(i))).position && "absolute" === p && ((j = "scrollHeight"), (P = "scrollWidth")), c === n || ((c === s || c === r) && l === d)))
                (x = o), (b -= (v && A === k && k.visualViewport ? k.visualViewport.height : A[j]) - a.height), (b *= f ? 1 : -1);
            ...
            return (
              ...
              (b = D.y),
              f
                ? Object.assign({}, S, (((C = {})[x] = L ? "0" : ""), (C[O] = E ? "0" : ""), (C.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + b + "px)" : "translate3d(" + y + "px, " + b + "px, 0)"), C))
          ...
          function yt(t, e) {
            ...
            var i = e,
              ...
              I = b === f ? D : C,
              M = { top: P.top - I.top + x.top, bottom: I.bottom - P.bottom + x.bottom, left: P.left - I.left + x.left, right: I.right - P.right + x.right },
          ...
          function kt(t, e, i) {
            ...
            return (
              (r || (!r && !i)) &&
                (("body" !== A(e) || ut(a)) && (l = (n = e) !== T(n) && P(n) ? { scrollLeft: (o = n).scrollLeft, scrollTop: o.scrollTop } : lt(n)), P(e) ? (((d = V(e, !0)).x += e.clientLeft), (d.y += e.clientTop)) : a && (d.x = dt(a))),
              ...
              var o,
                ...
                d = {
                  ...
                  setOptions: function (i) {
                    ...
                    u(), (a.options = Object.assign({}, r, a.options, o)), (a.scrollParents = { reference: j(t) ? ft(t) : t.contextElement ? ft(t.contextElement) : [], popper: ft(e) });
                    var s = (function (t) {
                      var e = At(t);
        ...
        902: function (t, e) {
          ...
          var n = { alwaysOpen: !1, activeClasses: "bg-gray-100 dark:bg-gray-800 dark:text-white", inactiveClasses: "text-white", onOpen: function () {}, onClose: function () {}, onToggle: function () {} },
            o = (function () {
              function t(t, e) {
          ...
          function s() {
            ...
            document.querySelectorAll("[data-drawer-target]").forEach(function (e) {
              ...
              if (s) {
                ...
                r(i, t) ||
                  t.push({ id: i, object: new o(s, { placement: a || n.placement, bodyScrolling: c ? "true" === c : n.bodyScrolling, backdrop: l ? "true" === l : n.backdrop, edge: d ? "true" === d : n.edge, edgeOffset: u || n.edgeOffset }) });
          ...
          function c() {
            document.querySelectorAll("[data-dropdown-toggle]").forEach(function (t) {
              ...
              if (i) {
                ...
                new a(i, t, { placement: n || s.placement, triggerType: c || s.triggerType, offsetSkidding: o ? parseInt(o) : s.offsetSkidding, offsetDistance: r ? parseInt(r) : s.offsetDistance, delay: l ? parseInt(l) : s.delay });
        ...
        247: function (t, e) {
          ...
          var n = {
              ...
              inactiveClasses: "dark:border-transparent hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300",
              onShow: function () {},
            },
            o = (function () {
              function t(t, e) {
